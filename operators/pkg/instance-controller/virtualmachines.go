...
func (r *InstanceReconciler) EnforceVMEnvironment(ctx context.Context, instance *crownlabsv1alpha2.Instance,
...
func (r *InstanceReconciler) enforceVirtualMachine(ctx context.Context, instance *crownlabsv1alpha2.Instance,
	environment *crownlabsv1alpha2.Environment) error {
...
func (r *InstanceReconciler) enforceVirtualMachineInstance(ctx context.Context, instance *crownlabsv1alpha2.Instance,
	environment *crownlabsv1alpha2.Environment) error {
	log := ctrl.LoggerFrom(ctx)
