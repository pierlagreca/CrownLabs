...
import crownlabsv1alpha2 "github.com/netgroup-polito/CrownLabs/operators/api/v1alpha2"
...
func InstanceLabels(labels map[string]string, template *crownlabsv1alpha2.Template) (map[string]string, bool) {
	update := false
	if labels == nil {
