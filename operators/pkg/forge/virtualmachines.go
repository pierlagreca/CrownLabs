...
func VMReadinessProbe(environment *crownlabsv1alpha2.Environment) *virtv1.Probe {
	port := ServiceSSHPort
...
func DataVolumeTemplate(name string, environment *crownlabsv1alpha2.Environment) virtv1.DataVolumeTemplateSpec {
