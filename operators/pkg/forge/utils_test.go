...
var _ = Describe("Utils forging", func() {
	...
	ForgeInstance := func(namespace, name string) *crownlabsv1alpha2.Instance {
		return &crownlabsv1alpha2.Instance{ObjectMeta: metav1.ObjectMeta{Namespace: namespace, Name: name}}
	}
